# Contributing to helix-creative-spirals

Thank you for your interest in contributing to helix-creative-spirals! This document provides guidelines and instructions for contributing to the project.
...
1. **Fork the repository**
   ```bash
   # Go to https://github.com/Deathcharge/helix-creative-spirals
   # Click "Fork" button
   ```

2. **Clone your fork**
   ```bash
   git clone https://github.com/YOUR_USERNAME/helix-creative-spirals.git
   cd helix-creative-spirals
   ```

3. **Add upstream remote**
   ```bash
   git remote add upstream https://github.com/Deathcharge/helix-creative-spirals.git
   ```
...
- **Questions**: Use [GitHub Discussions](https://github.com/Deathcharge/helix-creative-spirals/discussions)
- **Issues**: Use [GitHub Issues](https://github.com/Deathcharge/helix-creative-spirals/issues)
